...
public class AnimalTypesRepository
{
    public List<AnimalType> GetAll()
    {
        ...
        command.CommandText = "SELECT _Id, Name FROM AnimalTypes ORDER BY Name";
    ...
    public void Add(string name)
    {
        ...
        var command = connection.CreateCommand();
        command.CommandText = "INSERT INTO AnimalTypes (Name) VALUES ($name)";
    ...
    public void Delete(string name)
    {
        ...
        var command = connection.CreateCommand();
        command.CommandText = "DELETE FROM AnimalTypes WHERE LOWER(Name) = LOWER($name)";
        command.Parameters.AddWithValue("$name", name);
    ...
    private bool Exists(string name)
    {
        ...
        var command = connection.CreateCommand();
        command.CommandText = "SELECT COUNT(*) FROM AnimalTypes WHERE LOWER(Name) = LOWER($name)";
        command.Parameters.AddWithValue("$name", name);
